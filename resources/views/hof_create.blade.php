            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <img src="/img/hof.png" alt="Workflow logo" />
                        <p class="mt-1 text-sm leading-5 text-gray-600">
                           Please upload the screenshot of your rating update or your profile showing your rating
                        </p>
                    </div>
                </div>
...
@section('scripts')
    <script>
        ...
        uppyOne
            ...
            .use(XHRUpload, {endpoint: '/hof/uppy',formData:true,fieldName:'file',headers:{'X-CSRF-TOKEN':"{{csrf_token()}}"}})
