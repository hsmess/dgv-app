        ...
        <div class="bg-gray-50">
            <div class="pt-12 ml-2 mt-2">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DGV Tournaments.</p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: harry+contact@hsmess.dev</li>
                </ul>
                <h1>Account Creation</h1>
                <p>We will use your email address only to create an account on your behalf. You will not be contacted ever by the system.</p>
                <h1>Media Upload</h1>
                <p>All media will be stored in the EEA. Media will be viewable on the site by registred users</p>
                <p>We will observe DMCA takedown requests. These should be made:</p>
                <ul>
                    <li>By email: harry+contact@hsmess.dev</li>
                </ul>
